This project includes training of five different models with five different machine learning algorithms, used to predict the five different diseases such as:
